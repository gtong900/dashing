...
MatSelectModule, MatFormFieldModule, MatTableModule, MatPaginatorModule, MatSortModule,
MatProgressBarModule, MatIconModule, MatDialogModule } from '@angular/material';
...
import { DeleteDialogComponent } from './components/template/delete-dialog/delete-dialog.component';
...
@NgModule({
  ...
  imports: [
    ...
    MatSelectModule, MatFormFieldModule, MatTableModule, MatPaginatorModule, MatSortModule,
    MatProgressBarModule, MatIconModule, MatDialogModule,
